...
function Register() {
  ...
  return (
    <div className="flex flex-wrap w-full w-full content-center justify-center bg-gray-150">
      <div className="flex shadow-md w-full">
        <div className="flex flex-wrap content-center justify-center rounded-l-md bg-white w-1/2">
          <div className="w-full">
            <div className="flex items-center justify-center">
              ...
              <span className="ml-2 text-4xl font-bold">SIMS PPOB</span>
            </div>
              ...
              <form className="mt-6" onSubmit={handleSubmit}>
                <div className="mb-6">
                  <input
                    ...
                    className="block w-full rounded-md border border-gray-300 focus:border-purple-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-1.5 text-gray-500 h-12"
                  />
                </div>
                <div className="mb-6">
                  <input
                ...
                <div className="mb-3">
                  <button
                    type="submit"
                    className="mb-1.5 block w-full text-center text-white bg-red-500 hover:bg-red-900 px-2 py-1.5 rounded-md h-12"
                  >
                    Registrasi
                  </button>
                </div>
        ...
        <div className="flex flex-wrap content-center justify-center rounded-r-md w-6/12 h-screen overflow-hidden">
          <img src={image} alt="Registration Background" />
        </div>
      </div>
    </div>
  );
